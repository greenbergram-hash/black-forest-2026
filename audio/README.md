...
הראשונה של האפליקציה תוריד את כל הפרקים. הם נשמרים למטמון נפרד
(`bf2026-audio`) דרך הכפתור "הורדת הפודקאסטים של היום" בלשונית "עכשיו",
או בהאזנה ראשונה — והמטמון הזה שורד עדכוני גרסה של האפליקציה.
